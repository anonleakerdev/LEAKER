...
class Backend(ABC):
    """
    A backend for loading data sets and query logs. It encapsulates a specific method of storing and querying text corpora. It would
    usually be paired with a specific type of Dataset or KeywordQueryLog.
