...
Author(s) ommitted due to anonymity
########################################################################################################################
...
Please carefully review all of these files and, if you are ok with sharing them, send it to us (anonymous for submission) with a written permission that this data may be used in a publication.
We will not acknowledge your name in any way and only use a pseudonym like 'GMail User 3'.

########################################################################################################################

For questions or if issues arise, don't hesitate to contact (anonymous for submission).
